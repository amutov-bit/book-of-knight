...
public class SpineTexturesBookAnimation extends Group{
    ...
    public SpineTexturesBookAnimation(BookOfKnight game){
		this.game = game;
		 stopAnimatopn = false;
	}
	...
	public void loadAssetsSpine(int currentFile) {
    	...
    	{
    		case 0:
    			game.ondemandAssetManager.load("spine/book_1070x770.atlas", TextureAtlas.class);
    		break;
    		case 1:
    			game.ondemandAssetManager.load("spine/book_1070x770.json", File.class);
    		break;
    		case 2:
    			break;
    		case 3:
	...
	public void commitAssetsSpine(){
		...
		SkeletonJson json = new SkeletonJson(game.manager.get("spine/book_1070x770.atlas", TextureAtlas.class));
		SkeletonData playerSkeletonData = json.readSkeletonData(game.manager.get("spine/book_1070x770.json", File.class).getFile());
