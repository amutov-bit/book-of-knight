...
public class SpineTexturesButton extends Group{
    ...
    public SpineTexturesButton(BookOfKnight game){
		this.game = game;
		 stopAnimatopn = false;
	}
	...
	public void loadAssetsSpine(int currentFile) {
    	...
    	{
    		case 0:
    			game.ondemandAssetManager.load("spine/button.atlas", TextureAtlas.class);
    		break;
    		case 1:
    			game.ondemandAssetManager.load("spine/button.json", File.class);
    		break;
    		case 2:
    			break;
    		case 3:
	...
	public void commitAssetsSpine(){
		...
		SkeletonJson json = new SkeletonJson(game.manager.get("spine/button.atlas", TextureAtlas.class));
		SkeletonData playerSkeletonData = json.readSkeletonData(game.manager.get("spine/button.json", File.class).getFile());
...
//        skeleton.get(0).getRootBone().setScale(1.03f, 1.03f);
