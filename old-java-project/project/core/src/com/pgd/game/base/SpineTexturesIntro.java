...
public class SpineTexturesIntro extends Group{
    ...
    public SpineTexturesIntro(BookOfKnight game){
		this.game = game;
		 stopAnimatopn = false;
	}
	...
	public void loadAssetsSpine(int currentFile) {
    	...
    	{
    		case 0:
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v12.png", Texture.class);
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v13.png", Texture.class);
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v14.png", Texture.class);
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v15.png", Texture.class);
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v16.png", Texture.class);
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v17.png", Texture.class);
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v18.png", Texture.class);
    		break;
    		case 1:
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v1.atlas", TextureAtlas.class);
    		break;
    		case 2:
    			game.ondemandAssetManager.load("spine/intro/1920_intro_v1.json", File.class);
    			break;
    		case 3:
    			break;
    		case 4:
	...
	public void commitAssetsSpine(){
		...
		SkeletonJson json = new SkeletonJson(game.manager.get("spine/intro/1920_intro_v1.atlas", TextureAtlas.class));
		SkeletonData playerSkeletonData = json.readSkeletonData(game.manager.get("spine/intro/1920_intro_v1.json", File.class).getFile());
        ...
        animationState.get(0).setAnimation(0, "animation3", false);
