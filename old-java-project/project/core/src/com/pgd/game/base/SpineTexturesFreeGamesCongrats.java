...
public class SpineTexturesFreeGamesCongrats extends Group{
    ...
    public SpineTexturesFreeGamesCongrats(BookOfKnight game){
		this.game = game;
		 stopAnimatopn = false;
	}
	...
	public void loadAssetsSpine(int currentFile) {
    	...
    	{
    		case 0:
    			game.ondemandAssetManager.load("spine/1920_congrats_v1.atlas", TextureAtlas.class);
    		break;
    		case 1:
    			game.ondemandAssetManager.load("spine/1920_congrats_v1.json", File.class);
    		break;
    		case 2:
    			break;
    		case 3:
	...
	public void commitAssetsSpine(){
		...
		SkeletonJson json = new SkeletonJson(game.manager.get("spine/1920_congrats_v1.atlas", TextureAtlas.class));
		SkeletonData playerSkeletonData = json.readSkeletonData(game.manager.get("spine/1920_congrats_v1.json", File.class).getFile());
