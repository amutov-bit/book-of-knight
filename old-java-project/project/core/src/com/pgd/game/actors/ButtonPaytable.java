...
public class ButtonPaytable extends Actor {
...
//	private boolean toggled = false;
	 ...
	 * Constructor
	 */
	public ButtonPaytable(BookOfKnight game, int x, int y, TextureAtlas textureAtlas, String buttonName) {
		this.game = game;
...
//			    	Gdx.app.debug("Button", "released");
		...
		//#192e3e 		 25, 46, 62
		text.add(new Label(" ", new LabelStyle(game.fonts.font36px, new Color(138/255f, 158/255f, 181/255f, 255f/255f))));
...
//		#8a9eb5 138, 158, 181
		text.add(new Label(" ", new LabelStyle(game.fonts.font36px, new Color(25/255f, 46/255f, 62/255f, 204f/255f))));
...
//		text.get(1).setBounds(xX,yY,regions.get(0).getRegionWidth(),regions.get(0).getRegionHeight());
		...
		text.add(new Label(" ", new LabelStyle(game.fonts.font36px, new Color(179/255f, 182/255f, 238/255f, 255f/255f))));
...
//		Gdx.app.debug("draw", "currentFrame() = " +currentFrame);
		{
			text.get(currentFrame).setAlignment(Align.center);
			text.get(currentFrame).setBounds(getX(),getY() - 20, 172, 62 - 80);
