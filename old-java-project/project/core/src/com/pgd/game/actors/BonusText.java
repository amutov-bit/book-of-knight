...
public class BonusText extends Group {
	...
	public BonusText(BookOfKnight game) {
		this.game = game;
...
//		if(visible)	game.sounds.play(SoundTrack.BOOM, false);
//		else		game.sounds.stop(SoundTrack.BOOM);
	}
