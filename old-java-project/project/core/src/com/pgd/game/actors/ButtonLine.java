...
public class ButtonLine extends Actor {
...
//	private boolean toggled = false;
	 ...
	 * Constructor
	 */
	public ButtonLine(BookOfKnight game, int x, int y, TextureAtlas textureAtlas, String buttonName) {
		this.game = game;
...
//		toggledFrame = disabledFrame;
	...
	//			    	Gdx.app.debug("Button", "released");
		...
		text.add(new Label(" ", new LabelStyle(game.fonts.font60px, new Color(255f/255f, 255f/255f, 255f/255f, 255f/255f))));
		text.get(0).setFontScale(1.5f);
	}
...
//    			regions.get(currentFrame).getRegionHeight());
		...
		if(this.buttonName == "button_start_autoplay"){
			text.get(0).setAlignment(Align.center);
			text.get(0).setBounds(getX() + 10, getY() - 12, 300, 300);
