...
public class ShowWin extends Group {
	...
	public ShowWin(BookOfKnight game) {
		this.game = game;
...
//		animate = false;
	...
	public void commitAssets() {
		...
		game.textures.getInterfaceCommon().findRegion("win_bg").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		bg = new Image(new Sprite(game.textures.getInterfaceCommon().findRegion("win_bg")));
		bg.setPosition(getX() + 320 + 110 + 200 , getY() + 540 - 38 - 7 - 250 + 110 + 100);

		setWidth(game.textures.getInterfaceCommon().findRegion("win_bg").getRegionWidth());
		setHeight(game.textures.getInterfaceCommon().findRegion("win_bg").getRegionHeight());

		backgroundWidth = game.textures.getInterfaceCommon().findRegion("win_bg").getRegionWidth();
		offsetW = 0;
