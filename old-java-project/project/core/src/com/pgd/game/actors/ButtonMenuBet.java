...
public class ButtonMenuBet extends Actor {
...
//	private boolean toggled = false;
	 ...
	 * Constructor
	 */
	public ButtonMenuBet(BookOfKnight game, int x, int y, TextureAtlas textureAtlas, String buttonName) {
		this.game = game;
...
//		#bee1f5 190, 225, 245
		text.add(new Label(" ", new LabelStyle(game.fonts.font46px, new Color(190/255f, 225/255f, 245/255f, 255f/255f))));
...
//		Gdx.app.debug("draw", "getX() = " + getX());
		{
			text.get(0).setAlignment(Align.center);
			text.get(0).setBounds(getX(),getY(), getWidth(), getHeight());
