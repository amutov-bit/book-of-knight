...
public class ButtonAutoPlay extends Actor {
...
//	private boolean toggled = false;
	 ...
	 * Constructor
	 */
	public ButtonAutoPlay(BookOfKnight game, int x, int y, TextureAtlas textureAtlas, String buttonName) {
		this.game = game;
...
//		#bee1f5 190, 225, 245
		text.add(new Label(" ", new LabelStyle(game.fonts.font60px, new Color(190/255f, 225/255f, 245/255f, 255f/255f))));
		text.add(new Label(" ", new LabelStyle(game.fonts.font60px, new Color(190/255f, 225/255f, 245/255f, 255f/255f))));
		text.add(new Label(" ", new LabelStyle(game.fonts.font60px, new Color(190/255f, 225/255f, 245/255f, 255f/255f))));
