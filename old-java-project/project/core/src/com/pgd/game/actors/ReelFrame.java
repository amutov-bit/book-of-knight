...
public class ReelFrame extends Group {
...
//	Image interfaceMenu;
    ...
    public ReelFrame(BookOfKnight game) {
		super();
		this.game = game;
	...
	public void commitAssets() {
		...
		Texture texture = game.manager.get("reels_frame.png", Texture.class);
		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		normal = new Image(texture);	
		
		texture = game.manager.get("reels_frame_fg_haw.png", Texture.class);
		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		freegames = new Image(texture);
		
		
//		texture = game.manager.get("reels_frame_haw.png", Texture.class);
//		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
