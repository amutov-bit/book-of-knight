...
public class HelpScreenPaytable extends Group {
...
//	private Label textWild;
	...
	public enum TextsLabels {
		...
		NINE_X5(9,5, 200, 40 + 32 * 2, 5000),
		NINE_X4(9,4, 200, 40 + 32 * 1, 1000),
		NINE_X3(9,3, 200, 40 + 32 * 0, 100), 
		NINE_X2(9,2, 200, 40 - 32 * 1, 5), 
...
//			labelNumber.setText("" + this.cnt + ".");
	...
	public HelpScreenPaytable(BookOfKnight game, int i) {
		id = i;
		this.game = game;	
	}
	...
	public void commitAssets() {
		...
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("book_blur"))));
		stackedSymbol.get(0).setVisible(true);
		addActor(stackedSymbol.get(0));
		
		game.textures.getSymbolsAtlas().findRegion("10_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("10_blur"))));
		stackedSymbol.get(1).setVisible(true);		
		addActor(stackedSymbol.get(1));

		game.textures.getSymbolsAtlas().findRegion("J_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("J_blur"))));
		stackedSymbol.get(2).setVisible(true);
		addActor(stackedSymbol.get(2));

		game.textures.getSymbolsAtlas().findRegion("Q_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("Q_blur"))));
		stackedSymbol.get(3).setVisible(true);
		addActor(stackedSymbol.get(3));

		game.textures.getSymbolsAtlas().findRegion("K_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("K_blur"))));
		stackedSymbol.get(4).setVisible(true);
		addActor(stackedSymbol.get(4));

		game.textures.getSymbolsAtlas().findRegion("A_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("A_blur"))));
		stackedSymbol.get(5).setVisible(true);
		addActor(stackedSymbol.get(5));

		game.textures.getSymbolsAtlas().findRegion("torch_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("torch_blur"))));
		stackedSymbol.get(6).setVisible(true);
		addActor(stackedSymbol.get(6));
		
		game.textures.getSymbolsAtlas().findRegion("axe_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("axe_blur"))));
		stackedSymbol.get(7).setVisible(true);
		addActor(stackedSymbol.get(7));

		game.textures.getSymbolsAtlas().findRegion("chalice_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("chalice_blur"))));
		stackedSymbol.get(8).setVisible(true);
		addActor(stackedSymbol.get(8));

		game.textures.getSymbolsAtlas().findRegion("knight_blur").getTexture().setFilter(TextureFilter.Linear, TextureFilter.Linear);
		stackedSymbol.add(new Image(new Sprite(game.textures.getSymbolsAtlas().findRegion("knight_blur"))));
		...
		stackedSymbol.get(1).setPosition(110 + 330 * 4, 400);
		stackedSymbol.get(2).setPosition(110 + 330 * 3, 400);
		stackedSymbol.get(3).setPosition(110 + 330 * 2, 400);
		stackedSymbol.get(4).setPosition(110 + 330 * 1, 400);
		stackedSymbol.get(5).setPosition(110 + 330 * 0, 400);
		
		stackedSymbol.get(6).setPosition(200 - 35 + 410 * 3 - 30, 600);
		stackedSymbol.get(7).setPosition(200 - 35 + 410 * 2 - 15, 600);
		stackedSymbol.get(8).setPosition(200 - 35 + 410 * 1, 600);
		stackedSymbol.get(9).setPosition(200 - 35 + 410 * 0, 570);
		

		stackedSymbol.get(0).setScale(0.5f);
		stackedSymbol.get(1).setScale(0.5f);
		stackedSymbol.get(2).setScale(0.5f);
		stackedSymbol.get(3).setScale(0.5f);
		stackedSymbol.get(4).setScale(0.5f);
		stackedSymbol.get(5).setScale(0.5f);
		stackedSymbol.get(6).setScale(0.5f);
		stackedSymbol.get(7).setScale(0.5f);
		stackedSymbol.get(8).setScale(0.5f);
		stackedSymbol.get(9).setScale(0.5f);
...
//		wildLabel.setPosition(stackedSymbol.get(8).getX() + 160, stackedSymbol.get(8).getY() + 55);
		...
		if(game.languageCode == "FRA"){
			stackedSymbol.get(0).setPosition(660 - 100, 800 - 50);
			scatterLabel.setPosition(stackedSymbol.get(0).getX() + 145 - 100, stackedSymbol.get(0).getY() + 55 - 50);
		}
		...
		// TODO Auto-generated method stub
			for(TextsLabels label : TextsLabels.values()) {
				...
				if(game.languageCode != "ENG"){
					stackedSymbol.get(0).setPosition(660 - 100, 800);
				}
